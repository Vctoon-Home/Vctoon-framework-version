...
namespace VctoonCore.Migrations
{
    ...
    [Migration("20230831061631_Update_740RC2")]
    partial class Update_740RC2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VctoonCore.Libraries.Library", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VctoonCore.Libraries.LibraryFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppLibraryFiles", (string)null);
                });

            modelBuilder.Entity("VctoonCore.Libraries.LibraryPath", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VctoonCore.Resources.Comic", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VctoonCore.Resources.ComicChapter", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppComicChapters", (string)null);
                });

            modelBuilder.Entity("VctoonCore.Resources.ComicImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppComicImages", (string)null);
                });

            modelBuilder.Entity("VctoonCore.Resources.ResourceCollection", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VctoonCore.Resources.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VctoonCore.Resources.Video", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ComicTag", b =>
                {
                    b.HasOne("VctoonCore.Resources.Comic", null)
                        .WithMany()
                        .HasForeignKey("ComicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VctoonCore.Resources.Tag", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TagVideo", b =>
                {
                    ...
                    b.HasOne("VctoonCore.Resources.Video", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VctoonCore.Libraries.LibraryFile", b =>
                {
                    b.HasOne("VctoonCore.Libraries.LibraryPath", null)
                        .WithMany("Files")
            ...
            modelBuilder.Entity("VctoonCore.Libraries.LibraryPath", b =>
                {
                    b.HasOne("VctoonCore.Libraries.Library", null)
                        .WithMany("Paths")
            ...
            modelBuilder.Entity("VctoonCore.Resources.Comic", b =>
                {
                    ...
                    b.HasOne("VctoonCore.Resources.ResourceCollection", null)
                        .WithMany("Comics")
            ...
            modelBuilder.Entity("VctoonCore.Resources.ComicImage", b =>
                {
                    b.HasOne("VctoonCore.Resources.ComicChapter", null)
                        .WithMany("Images")
