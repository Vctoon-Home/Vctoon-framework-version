        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppLibraryPaths_AppLibraryPaths_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppComics_ResourceCollections_ResourceCollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppVideos_ResourceCollections_ResourceCollectionId",
                        column: x => x.ResourceCollectionId,
                        principalTable: "ResourceCollections",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModifyTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    LastResolveTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppLibraryFiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppLibraryFiles_AppLibraryPaths_LibraryPathId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppComicChapters", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppComicChapters_AppComics_ComicId",
                        column: x => x.ComicId,
                        principalTable: "AppComics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppComicChapters_AppLibraryPaths_LibraryPathId",
                        column: x => x.LibraryPathId,
                        principalTable: "AppLibraryPaths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComicTag", x => new { x.ComicId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_ComicTag_AppComics_ComicId",
                        column: x => x.ComicId,
                        principalTable: "AppComics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ComicTag_AppTags_TagsId",
                        column: x => x.TagsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TagVideo_AppTags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "AppTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagVideo_AppVideos_VideoId",
                        column: x => x.VideoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppComicImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppComicImages_AppComicChapters_ComicChapterId",
                        column: x => x.ComicChapterId,
                        principalTable: "AppComicChapters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppComicChapters_ComicId",
                table: "AppComicChapters",
                column: "ComicId");

            migrationBuilder.CreateIndex(
                name: "IX_AppComicChapters_LibraryPathId",
                table: "AppComicChapters",
                column: "LibraryPathId");

            migrationBuilder.CreateIndex(
                name: "IX_AppComicImages_ComicChapterId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppComics_ResourceCollectionId",
                table: "AppComics",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppLibraryFiles_LibraryPathId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppLibraryPaths_ParentId",
                table: "AppLibraryPaths",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_AppLibraryPaths_Path",
                table: "AppLibraryPaths",
                column: "Path",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppVideos_ResourceCollectionId",
                table: "AppVideos",
                column: "ResourceCollectionId");
