using VctoonCore.EntityFrameworkCore.ModelCreatingExtensions;
...
public class VctoonCoreDbContext :
    AbpDbContext<VctoonCoreDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public VctoonCoreDbContext(DbContextOptions<VctoonCoreDbContext> options)
        : base(options)
    {
    }
